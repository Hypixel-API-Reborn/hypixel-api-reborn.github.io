  ...
  [1],
  {
    ...
    NHnr: function (e, t, s) {
      ...
      function c(e, t, s, r, a) {
        return Object($t.resolve)(e, t + '/' + s + (r ? '/' + r : '') + (a ? '#L' + a : ''));
      }
      function l(e, t) {
              ...
              link:
                'object' === Tt()(t.links[a[0]])
                  ? {
                      ...
                      query: { scrollTo: a[1] ? ('.' === a[1] ? 's-' : '') + a[2] : void 0 }
                    }
                  : t.links[a[0]]
            }
          : e.match(/^https?:\/\//i)
      ...
      function d(e, t, s, r) {
        if (!e) return null;
        for (var a = /\{@link\s+(.+?)(?:\s+(.+?))?\s*\}/gi, o = void 0, n = '', i = 0; (o = a.exec(e)); ) {
          n += e.slice(i, o.index);
          var c = l(o[0], t);
          if (c.link) {
            var d = void 0;
      ...
      var D = s('/5sW'),
            ...
            ie()(e, [
              {
                ...
                value: function () {
                  ...
                  return this.tags
                    ...
                    : re.a
                        .all([
                          fetch('https://api.github.com/repos/' + this.repo + '/branches').then(ce),
                          fetch('https://api.github.com/repos/' + this.repo + '/tags').then(ce)
                        ])
                        .catch(function (t) {
                        ...
                        .then(function (t) {
                          var s = te()(t, 2),
                            r = s[0],
                            a = s[1];
                          (e.tags = [e.defaultTag]), (localStorage['source-' + e.id] = X()({ branches: r, tags: a }));
                          var o = !0,
                            n = !1,
                            i = void 0;
                          try {
                            for (var c, l = Y()(r); !(o = (c = l.next()).done); o = !0) {
                              var d = c.value;
                          ...
                          var u = {},
                            ...
                            h = void 0;
                          try {
                            for (var f, v = Y()(a); !(p = (f = v.next()).done); p = !0) {
                              var g = f.value;
                              if (J.a.valid(g.name)) {
                                var _ = J.a.major(g.name) + '.' + J.a.minor(g.name),
                                  y = J.a.patch(g.name);
                                if (y < u[_]) continue;
                                u[_] = y;
                              }
                          ...
                          var C = !0,
                            ...
                            k = void 0;
                          try {
                            for (var L, w = Y()(a); !(C = (L = w.next()).done); C = !0) {
                              var M = L.value;
                              if (M.name !== e.defaultTag && e.tagFilter(M.name)) {
                                if (J.a.valid(M.name)) {
                                  var x = J.a.major(M.name) + '.' + J.a.minor(M.name);
              ...
              },
              {
                key: 'fetchDocs',
                value: function (e) {
                  return fetch('https://raw.githubusercontent.com/' + this.repo + '/docs/' + e + '.json').then(ce);
                }
              }
            ]),
            e
        ...
        pe = new de({
          ...
          branchFilter: function (e) {
            return !ue.includes(e) && !e.startsWith('dependabot/') && !e === 'docs';
          },
        ...
        me = {
          ...
          data: function () {
            return {
              ...
              tutorials: { category: pe.defaultFile.category, file: pe.defaultFile.id }
            };
          },
          computed: {
            tag: function () {
                ...
                [
                  ...
                  s(
                    ...
                    [
                      ...
                      e._v(' '),
                      s('a', { attrs: { href: 'https://discord.gg/8hk5wSpSsK' } }, [e._v('FAQ')])
                    ],
                    1
                  )
                ],
        ...
        Te = function () {},
        $e = { downloads: 'many', stars: 'a lot', contributors: 'some', fetching: !1 },
        Se = {
          name: 'stats',
          data: function () {
            return $e;
                    ...
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 5:
                            if (((s = t.sent), (r = te()(s, 3)), (a = r[0]), (o = r[1]), (n = r[2]), !a)) {
                              t.next = 32;
                              break;
                            }
                            for (
                              e.downloads = 0, i = !0, c = !1, l = void 0, t.prev = 15, d = Y()(a.downloads);
                              !(i = (u = d.next()).done);
                              i = !0
                            )
                          ...
                          case 23:
                            (t.prev = 23), (t.prev = 24), !i && d.return && d.return();
                          case 26:
                            if (((t.prev = 26), !c)) {
                              t.next = 29;
                              break;
                          ...
                          case 32:
                            o && (e.stars = o.stargazers_count.toLocaleString()),
            ...
            [
              s(
                ...
                [
                  ...
                  e._v(' '),
                  s('p', [e._v('A feature-rich Hypixel API wrapper for Node.js')]),
                  e._v(' '),
                  s('p', [
        ...
        Je = {
          ...
          data: function () {
            ...
            return { darkMode: 'false' !== e && null !== e, repository: pe.repo, konami: !1 };
          },
          methods: {
        ...
        At = {
          ...
          data: function () {
            return { sources: Lt()({}, pe.id, pe), source: pe, tag: pe.defaultTag };
          },
          methods: {
            ...
            handleRoute: function (e) {
              return e.params.source && this.sources[e.params.source]
                ...
                : void this.$router.replace({
                    name: 'docs-class',
                    params: { source: pe.id, tag: pe.defaultTag, class: pe.defaultClass }
                  });
            },
            toggleDarkMode: function () {
                    ...
                    .then(function (r) {
                      if (e.source === t && e.tag === s) {
                        ...
                        var a = !0,
                          ...
                          n = void 0;
                        try {
                          for (var i, c = Y()(r.classes); !(a = (i = c.next()).done); a = !0) {
                            var l = i.value;
                            l.props &&
                        ...
                        var d = !0,
                          ...
                          p = void 0;
                        try {
                          for (var m, h = Y()(r.externals); !(d = (m = h.next()).done); d = !0) {
                            var f = m.value;
                            r.links[f.name] = f.see[0].replace(/\{@link\s+(.+?)\s*\}/i, '$1');
                          }
                        } catch (e) {
                          (u = !0), (p = e);
                        } finally {
                        ...
                        var v = !0,
                          ...
                          _ = void 0;
                        try {
                          for (var y, C = Y()(r.classes); !(v = (y = C.next()).done); v = !0) {
                            var b = y.value;
                            r.links[b.name] = { name: 'docs-class', params: { class: b.name } };
                          }
                        } catch (e) {
                          (g = !0), (_ = e);
                        } finally {
                        ...
                        var k = !0,
                          ...
                          w = void 0;
                        try {
                          for (var M, x = Y()(r.typedefs); !(k = (M = x.next()).done); k = !0) {
                            var T = M.value;
                            r.links[T.name] = { name: 'docs-typedef', params: { typedef: T.name } };
                          }
                        } catch (e) {
                          (L = !0), (w = e);
                        } finally {
                          ...
                          (St.switching = !1),
                            'docs-class' === $.name
                              ...
                              : 'docs-typedef' === $.name
                                ...
                                : 'docs-file' === $.name &&
                                  ((r.custom[$.params.category] && r.custom[$.params.category].files[$.params.file]) ||
                                    e.goHome());
                        }
                      }
                    })
                              ...
                              e._l(t.files, function (t, a) {
                                return s(
                                  ...
                                  [
                                    s(
                                      'router-link',
                                      { attrs: { to: { name: 'docs-file', params: { category: r, file: a } } } },
                                      [e._v('\n                ' + e._s(t.name) + '\n              ')]
                                    )
                                  ],
                                  1
          ...
          mounted: function () {
            ...
            this.$nextTick(function () {
              var t = !0,
                ...
                r = void 0;
              try {
                for (var a, o = Y()(e.$el.querySelectorAll('pre code')); !(t = (a = o.next()).done); t = !0) {
                  i(a.value);
                }
              } catch (e) {
                (s = !0), (r = e);
        ...
        dr = {
          ...
          methods: {
            ...
            paramDescription: function (e) {
              return D.a.filter('marked')(d(e.description, this.docs, this.$router, this.$route));
            },
        ...
        Ur = {
          ...
          computed: {
            description: function () {
              return D.a.filter('marked')(d(this.prop.description, this.docs, this.$router, this.$route));
            },
            scrollTo: function () {
        ...
        Ir = {
          name: 'class-method',
          props: ['method', 'docs'],
          components: { Types: lr, TypeLink: er, ParamTable: _r, SourceButton: Us, See: qr },
          computed: {
            params: function () {
            ...
            description: function () {
              return D.a.filter('marked')(d(this.method.description, this.docs, this.$router, this.$route));
            },
            emits: function () {
              var e = this;
        ...
        ta = {
          ...
          computed: {
            description: function () {
              return D.a.filter('marked')(d(this.event.description, this.docs, this.$router, this.$route));
            }
          }
        },
        sa = function () {
        ...
        da = {
          ...
          computed: {
            ...
            description: function () {
              return D.a.filter('marked')(d(this.clarse.description, this.docs, this.$router, this.$route));
            }
          },
        ...
        ya = {
          ...
          computed: {
            description: function () {
              return D.a.filter('marked')(d(this.typedef.description, this.docs, this.$router, this.$route));
            },
            returnsDescription: function () {
              var e = this.typedef.returns;
              return e ? D.a.filter('marked')(d(e.description, this.docs, this.$router, this.$route)) : '';
            }
          },
          methods: { typeKey: p },
          mounted: function () {
          ...
          computed: {
            results: function () {
              ...
              for (var i = 0; i < e.length; ) {
                var c = e[i];
                if ('Property' === c.item.type || 'Method' === c.item.type || 'Event' === c.item.type) {
                  var l = [],
                    d = !0,
                    p = !1,
                    m = void 0;
                  try {
                    for (var h, f = Y()(c.matches); !(d = (h = f.next()).done); d = !0) {
                      var v = h.value;
                      l.push(v.key);
                    }
                  } catch (e) {
                  ...
                  if (2 === l.length && l.includes('parent') && l.includes('fullName')) {
                    e.splice(i, 1);
                    continue;
                  }
                }
          ...
          methods: {
            ...
            buildFuse: function (e) {
              var t = [],
                ...
                a = void 0;
              try {
                for (var o, n = Y()(this.docs.classes); !(s = (o = n.next()).done); s = !0) {
                  var i = o.value;
                  if (this.showPrivate || 'private' !== i.access) {
                    if (
                      ...
                      var c = !0,
                        ...
                        d = void 0;
                      try {
                        for (var u, p = Y()(i.props); !(c = (u = p.next()).done); c = !0) {
                          var m = u.value;
                    ...
                    if (i.methods && e.methods) {
                      var h = !0,
                        ...
                        v = void 0;
                      try {
                        for (var g, _ = Y()(i.methods); !(h = (g = _.next()).done); h = !0) {
                          var y = g.value;
                    ...
                    if (i.events && e.events) {
                      var C = !0,
                        ...
                        k = void 0;
                      try {
                        for (var L, w = Y()(i.events); !(C = (L = w.next()).done); C = !0) {
                          var M = L.value;
                          (this.showPrivate || 'private' !== M.access) &&
                            t.push({
                              type: 'Event',
              ...
              if (e.typedefs) {
                var x = !0,
                  ...
                  $ = void 0;
                try {
                  for (var S, R = Y()(this.docs.typedefs); !(x = (S = R.next()).done); x = !0) {
                    var E = S.value;
                    ...
                    on: {
                      change: function (t) {
                        ...
                        if (Array.isArray(s)) {
                          var o = e._i(s, null);
                          r.checked
                            ? o < 0 && e.$set(e.toggles, 'classes', s.concat([null]))
                            : o > -1 && e.$set(e.toggles, 'classes', s.slice(0, o).concat(s.slice(o + 1)));
                    ...
                    on: {
                      change: function (t) {
                        ...
                        if (Array.isArray(s)) {
                          var o = e._i(s, null);
                          r.checked
                            ? o < 0 && e.$set(e.toggles, 'props', s.concat([null]))
                            : o > -1 && e.$set(e.toggles, 'props', s.slice(0, o).concat(s.slice(o + 1)));
                    ...
                    on: {
                      change: function (t) {
                        ...
                        if (Array.isArray(s)) {
                          var o = e._i(s, null);
                          r.checked
                            ? o < 0 && e.$set(e.toggles, 'methods', s.concat([null]))
                            : o > -1 && e.$set(e.toggles, 'methods', s.slice(0, o).concat(s.slice(o + 1)));
                    ...
                    on: {
                      change: function (t) {
                        ...
                        if (Array.isArray(s)) {
                          var o = e._i(s, null);
                          r.checked
                            ? o < 0 && e.$set(e.toggles, 'events', s.concat([null]))
                            : o > -1 && e.$set(e.toggles, 'events', s.slice(0, o).concat(s.slice(o + 1)));
                    ...
                    on: {
                      change: function (t) {
                        ...
                        if (Array.isArray(s)) {
                          var o = e._i(s, null);
                          r.checked
                            ? o < 0 && e.$set(e.toggles, 'typedefs', s.concat([null]))
                            : o > -1 && e.$set(e.toggles, 'typedefs', s.slice(0, o).concat(s.slice(o + 1)));
                  ...
                  children: [
                    {
                      ...
                      children: [
                        ...
                        { path: 'class/:class', name: 'docs-class', component: _a },
                        { path: 'typedef/:typedef', name: 'docs-typedef', component: Ta },
                        { path: ':category/:file', name: 'docs-file', component: Is }
                      ]
                    }
                  ]
                }
