                    ...
                    : re.a
                        ...
                        .then(function (t) {
                          ...
                          var o = !0,
                            ...
                            i = void 0;
                          try {
                            for (var c, l = Q()(r); !(o = (c = l.next()).done); o = !0) {
                              var d = c.value;
                          ...
                          var u = {},
                            ...
                            h = void 0;
                          try {
                            for (var f, v = Q()(a); !(p = (f = v.next()).done); p = !0) {
                              var g = f.value;
                              if (G.a.valid(g.name)) {
                                var _ = G.a.major(g.name) + '.' + G.a.minor(g.name),
                                  y = G.a.patch(g.name);
                                if (y < u[_]) continue;
                                u[_] = y;
                              }
                          ...
                          var C = !0,
                            ...
                            k = void 0;
                          try {
                            for (var L, w = Q()(a); !(C = (L = w.next()).done); C = !0) {
                              var M = L.value;
                              if (M.name !== e.defaultTag && e.tagFilter(M.name)) {
                                if (G.a.valid(M.name)) {
                                  var x = G.a.major(M.name) + '.' + G.a.minor(M.name);
                      ...
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 5:
                            ...
                            for (
                              e.downloads = 0, i = !0, c = !1, l = void 0, t.prev = 15, d = Q()(a.downloads);
                              !(i = (u = d.next()).done);
                              i = !0
                            )
                    ...
                    .then(function (r) {
                      if (e.source === t && e.tag === s) {
                        ...
                        var a = !0,
                          ...
                          n = void 0;
                        try {
                          for (var i, c = Q()(r.classes); !(a = (i = c.next()).done); a = !0) {
                            var l = i.value;
                            l.props &&
                        ...
                        var d = !0,
                          ...
                          p = void 0;
                        try {
                          for (var m, h = Q()(r.externals); !(d = (m = h.next()).done); d = !0) {
                            var f = m.value;
                        ...
                        var v = !0,
                          ...
                          _ = void 0;
                        try {
                          for (var y, C = Q()(r.classes); !(v = (y = C.next()).done); v = !0) {
                            var b = y.value;
                        ...
                        var k = !0,
                          ...
                          w = void 0;
                        try {
                          for (var M, x = Q()(r.typedefs); !(k = (M = x.next()).done); k = !0) {
                            var T = M.value;
          ...
          mounted: function () {
            ...
            this.$nextTick(function () {
              var t = !0,
                ...
                r = void 0;
              try {
                for (var a, o = Q()(e.$el.querySelectorAll('pre code')); !(t = (a = o.next()).done); t = !0) {
                  i(a.value);
                }
              } catch (e) {
                (s = !0), (r = e);
              ...
              for (var i = 0; i < e.length; ) {
                ...
                if ('Property' === c.item.type || 'Method' === c.item.type || 'Event' === c.item.type) {
                  var l = [],
                    ...
                    m = void 0;
                  try {
                    for (var h, f = Q()(c.matches); !(d = (h = f.next()).done); d = !0) {
                      var v = h.value;
                      l.push(v.key);
                    }
                  } catch (e) {
          ...
          methods: {
            ...
            buildFuse: function (e) {
              var t = [],
                ...
                a = void 0;
              try {
                for (var o, n = Q()(this.docs.classes); !(s = (o = n.next()).done); s = !0) {
                  var i = o.value;
                  if (this.showPrivate || 'private' !== i.access) {
                    if (
                      ...
                      var c = !0,
                        ...
                        d = void 0;
                      try {
                        for (var u, p = Q()(i.props); !(c = (u = p.next()).done); c = !0) {
                          var m = u.value;
                    ...
                    if (i.methods && e.methods) {
                      var h = !0,
                        ...
                        v = void 0;
                      try {
                        for (var g, _ = Q()(i.methods); !(h = (g = _.next()).done); h = !0) {
                          var y = g.value;
                    ...
                    if (i.events && e.events) {
                      var C = !0,
                        ...
                        k = void 0;
                      try {
                        for (var L, w = Q()(i.events); !(C = (L = w.next()).done); C = !0) {
                          var M = L.value;
                          (this.showPrivate || 'private' !== M.access) &&
                            t.push({
                              type: 'Event',
              ...
              if (e.typedefs) {
                var x = !0,
                  ...
                  $ = void 0;
                try {
                  for (var S, R = Q()(this.docs.typedefs); !(x = (S = R.next()).done); x = !0) {
                    var E = S.value;
